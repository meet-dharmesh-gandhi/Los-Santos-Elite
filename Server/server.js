...
const allowedOrigins = ['http://127.0.0.1:5500', "https://los-santos-elite-render-test-1.onrender.com", "https://los-santos-elite-9xdq.onrender.com"];
...
app.get("/pay/:amount", async (req, res) => {
	...
	const payLoad = {
		...
		name: "meet",
		amount,
		redirectUrl: `https://los-santos-elite-2gyo.onrender.com/redirect-url/${merchantTransactionId}`,
		redirectMode: "POST",
...
app.get("/pay-premium/:amount", async (req, res) => {
	...
	const payLoad = {
		...
		amount,
		redirectUrl: `https://los-santos-elite-2gyo.onrender.com/premium-redirect-url/${merchantTransactionId}/${amount}`,
